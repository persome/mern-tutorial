...
function Register() {
    ...
    useEffect(() => {
        ...
        // ? When '||' is replaced with '&&' on the condition below, the plage loads and  routes back to the dashboard page which is the root. When using '&&' registration data is created but the page doesn't go back to the root.
